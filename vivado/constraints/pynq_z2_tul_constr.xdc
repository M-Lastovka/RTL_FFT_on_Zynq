...
create_clock -add -name sys_clk_pin -period 3.00 -waveform {0 1.5} [get_ports { clk }];

##Switches

#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { reset_n_in }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { start_game_c_in }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]
